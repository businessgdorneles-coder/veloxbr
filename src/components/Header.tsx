...
const Header = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-black border-b border-white/10">
        <div className="container flex items-center justify-between py-3">
          ...
          <a href="/" className="absolute left-1/2 -translate-x-1/2">
            <img src={logo} alt="PrimeTAP" className="h-[60px] sm:h-[75px] object-contain" />
          </a>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 left-0 z-50 h-full w-72 bg-black shadow-2xl transform transition-transform duration-300 ease-in-out ${
