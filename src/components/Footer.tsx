    ...
    <footer className="bg-dark-section border-t border-white/10">
      ...
      <div className="container max-w-4xl py-10">
        <div className="grid sm:grid-cols-3 gap-8 mb-8 text-center sm:text-left">
          <div className="flex flex-col items-center sm:items-start">
            <div className="flex items-center gap-2 mb-3">
              <img src={logo} alt="PrimeTAP" className="h-[75px] object-contain" />
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:primetapautomotivo@gmail.com" className="flex items-center gap-2 text-white/50 hover:text-white text-xs transition-colors justify-center sm:justify-start">
                <Mail className="w-3.5 h-3.5 text-primary" /> primetapautomotivo@gmail.com
              </a>
              ...
              <a href="https://instagram.com/primetap.auto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/50 hover:text-white text-xs transition-colors justify-center sm:justify-start">
                <Instagram className="w-3.5 h-3.5 text-primary" /> @primetap.auto
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a href="https://instagram.com/primetap.auto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/40 hover:text-white/70 transition-colors">
            <Instagram className="w-4 h-4" />
            <span className="text-[11px]">@primetap.auto</span>
          </a>
