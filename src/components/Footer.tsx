        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-8 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:lojaveloxbr.auto@gmail.com" className="flex items-center gap-2 text-white/50 hover:text-white text-xs transition-colors justify-center sm:justify-start">
                <Mail className="w-3.5 h-3.5 text-primary" /> lojaveloxbr.auto@gmail.com
              </a>
