        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 min-w-0">
          ...
          <div className="space-y-5">
            ...
            <div className="border border-gray-200 rounded-lg p-5 bg-white">
              ...
              {/* Card verde: disponibilidade */}
              {canProceed && (
                <div className="mt-3 bg-green-600 text-white rounded-xl px-4 py-3 flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="font-bold text-sm uppercase tracking-wide">
                    {isOutro ? "Disponível" : "Modelo Disponível"}
                  </span>
                </div>
              )}
            </div>
